...
struct ComposeVideoRequest: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> ComposeVideoRequest? {
    ...
    let outputWidth: Int64? = nilOrValue(pigeonVar_list[17])
    let outputHeight: Int64? = nilOrValue(pigeonVar_list[18])
    let backgroundColorArgb: Int64? = nilOrValue(pigeonVar_list[19])
